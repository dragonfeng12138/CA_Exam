...
public class MyAdminUseReCe {
	private static JFrame window;
	 
	public static void cemera(String s, MyAdminUseRe f) throws InterruptedException {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e)
			{
				...
				//实现拍照保存-------start
				String fileName = "img/use/" + s;       //保存路径即图片名称（不用加后缀）
